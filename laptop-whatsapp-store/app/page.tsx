        ...
        <main className="container mx-auto px-4 py-10">
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the latest laptops for work, study, and gaming. 
              Order directly via WhatsApp with just a few clicks.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <a 
                href="#featured" 
                className="px-8 py-3 border border-blue-400 text-blue-400 hover:bg-blue-900/30 rounded-lg font-medium transition-colors"
              >
                View Featured
              </a>
            </div>
          ...
          <section id="featured" className="mb-20">
            <h2 className="text-3xl font-bold mb-8 text-center">Featured Laptops</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {laptops.filter(laptop => laptop.isFeatured).slice(0, 6).map((laptop) => (
            ...
            <div className="text-center mt-12">
              <Link 
                href="/products" 
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
              >
                View All {laptops.length} Laptops
          ...
          <section className="bg-gray-800 rounded-2xl p-8 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-4">Need Help Choosing?</h2>
              <p className="text-gray-300 mb-6">
                Our experts are here to help you find the perfect laptop for your needs. 
                Chat with us on WhatsApp for personalized recommendations.
              </p>
              <a 
                href="https://wa.me/254700000000?text=Hello!%20I%20need%20help%20choosing%20a%20laptop." 
                target="_blank"
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <h3 className="text-xl font-bold text-blue-400">Laptop Store</h3>
                <p className="text-gray-400">Your trusted laptop shop in Kenya</p>
              </div>
